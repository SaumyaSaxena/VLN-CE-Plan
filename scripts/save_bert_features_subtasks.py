...
def load_data(data_type='train', role='guide'):
    data_loc = f'/home/sax1rng/Projects/VLN-CE-Plan/data/datasets/RxR_VLNCE_v0/{data_type}/{data_type}_{role}_subtasks.json.gz'
    data = {}
...
if __name__== "__main__":
    ...
    save_dir = f'/fs/scratch/rng_cr_aas3_gpu_user_c_lf/sp02_025_rrt/datasets/rxr-data/text_features_subtasks/rxr_{data_type}/'
    ...
    while not done:
        ...
        for i in trange(n_batch*batch_size, batch_end):
            ...
            if os.path.exists(file_name):
                ...
                np.savez(file_name, features=output['sequence_output'][out_idx])
            out_idx += 1
