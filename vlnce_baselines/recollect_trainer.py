...
class RecollectTrainer(BaseVLNCETrainer):
    ...
    def print_gpu_memory_usage(self, msg):
        print(msg)
        print(f"Memory Allocated: {torch.cuda.memory_allocated(self.device) / 1024/1024} MB")
        print(f"Memory Reserved: {torch.cuda.memory_reserved(self.device) / 1024/1024} MB")
        print(f"Max Memory Allocated: {torch.cuda.max_memory_allocated(self.device) / 1024/1024} MB")
        print(f"Max Memory Reserved: {torch.cuda.max_memory_reserved(self.device) / 1024/1024} MB")
